...
const images = [
  ...
  "https://images.unsplash.com/photo-1549294413-26f195200c16?q=80&w=464&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
                ...
                <Card className={classes.card}>
                  {images.map((img, index) => (
                    <Card key={index} sx={{ maxWidth: 345 }}>
                      ...
                      />
                      <CardContent>
                        <Typography variant="h6">Imagem {index + 1}</Typography>
                      </CardContent>
                    </Card>
                  ))}
